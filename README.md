...
> export PROJ\_LIB="/scratch2/NCEPDEV/ovp/Marcel.Caron/anaconda3/share/proj"
```
If you use Csh:
```> setenv PATH="/scratch2/NCEPDEV/ovp/Marcel.Caron/anaconda3/bin:$PATH"
> setenv PROJ\_LIB="/scratch2/NCEPDEV/ovp/Marcel.Caron/anaconda3/share/proj"
```
...
- Under \[config\], set GRID\_STAT\_CONFIG_FILE to path to MET config file in your system \(provided in this repo\)
